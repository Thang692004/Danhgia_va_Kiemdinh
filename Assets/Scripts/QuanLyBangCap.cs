...
public class QuanLyBangCap : MonoBehaviour
{
    public string scriptUrl = "https://script.google.com/macros/s/AKfycby1CItno0zdXLCVDxex8WeFDOVVXWTZPoaSlCelh9UJ5q0AvI2xa8AyM50pEX4rbcBIRA/exec?sheet=BangHeSo";

    [Header("UI")]
    public GameObject contentPanel;
    public GameObject rowPrefab;
    public List<RectTransform> columnImages = new List<RectTransform>();
    public List<string> columns = new List<string> { "P (Bằng cấp)", "Tên Viết Tắt" };
    ...
    void ClearRows()
    {
        ...
        {
            if (child.CompareTag("CloneRow")) Destroy(child.gameObject);
        }
    }
}
